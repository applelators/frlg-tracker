...
const DT_HM_COMPAT = {
  "Cut":        new Set(["Bulbasaur","Ivysaur","Venusaur","Caterpie","Metapod","Butterfree","Weedle","Kakuna","Beedrill","Rattata","Raticate","Ekans","Arbok","Sandshrew","Sandslash","Nidoran♀","Nidorina","Nidoqueen","Nidoran♂","Nidorino","Nidoking","Oddish","Gloom","Vileplume","Paras","Parasect","Diglett","Dugtrio","Meowth","Persian","Psyduck","Golduck","Tentacool","Tentacruel","Farfetch'd","Seel","Krabby","Kingler","Rhyhorn","Rhydon","Kangaskhan","Scyther","Pinsir","Kabuto","Kabutops","Charizard","Bellsprout","Weepinbell","Victreebel","Dratini","Dragonair","Dragonite"]),
  ...
  "Strength":   new Set(["Bulbasaur","Ivysaur","Venusaur","Charmander","Charmeleon","Charizard","Squirtle","Wartortle","Blastoise","Sandshrew","Sandslash","Nidorina","Nidoqueen","Nidorino","Nidoking","Mankey","Primeape","Pikachu","Raichu","Poliwag","Poliwhirl","Poliwrath","Machop","Machoke","Geodude","Graveler","Golem","Slowpoke","Slowbro","Drowzee","Krabby","Kingler","Marowak","Hitmonlee","Hitmonchan","Rhyhorn","Rhydon","Chansey","Kangaskhan","Tauros","Gyarados","Lapras","Snorlax","Dratini","Dragonair","Dragonite","Arcanine","Aerodactyl","Electabuzz","Exeggcute","Exeggutor","Psyduck","Golduck"]),
...
const DT_CANDIDATES = [
  ...
  {name:"Golduck",   types:["Water"],                hms:["Surf","Waterfall","Cut","Strength","Rock Smash"],frOnly:true},
...
const DT_TM_TIPS = {
  "Charizard":  [{move:"Flamethrower",src:"TM35 — Game Corner, Celadon City"},{move:"Earthquake",src:"TM26 — Viridian Gym reward",oneTime:true},{move:"Dragon Claw",src:"TM02 — Cape Brink, Two Island"}],
  ...
  "Raichu":     [{move:"Thunderbolt",src:"TM24 — Game Corner, Celadon City"},{move:"Shadow Ball",src:"TM30 — Celadon Dept. Store (buyable)"}],
  ...
  "Snorlax":    [{move:"Earthquake",src:"TM26 — Viridian Gym reward",oneTime:true},{move:"Shadow Ball",src:"TM30 — Celadon Dept. Store (buyable)"}],
  "Vaporeon":   [{move:"Ice Beam",src:"TM13 — Game Corner, Celadon City"}],
  "Jolteon":    [{move:"Thunderbolt",src:"TM24 — Game Corner, Celadon City"},{move:"Shadow Ball",src:"TM30 — Celadon Dept. Store (buyable)"}],
  ...
  "Electabuzz": [{move:"Thunderbolt",src:"TM24 — Game Corner, Celadon City"},{move:"Shadow Ball",src:"TM30 — Celadon Dept. Store (buyable)"}],
  "Magneton":   [{move:"Thunderbolt",src:"TM24 — Game Corner, Celadon City"},{move:"Thunder",src:"TM25 — Game Corner, Celadon City"}],
  "Electrode":  [{move:"Thunderbolt",src:"TM24 — Game Corner, Celadon City"},{move:"Shadow Ball",src:"TM30 — Celadon Dept. Store (buyable)"}],
  "Sandslash":  [{move:"Earthquake",src:"TM26 — Viridian Gym reward",oneTime:true},{move:"Rock Slide",src:"TM80 — Celadon Dept. Store (buyable)"}],
  "Aerodactyl": [{move:"Iron Tail",src:"TM23 — Silph Co.",oneTime:true},{move:"Rock Slide",src:"TM80 — Celadon Dept. Store (buyable)"}],
  "Pidgeot":    [{move:"Hyper Beam",src:"TM15 — Game Corner, Celadon City"}],
  "Poliwrath":  [{move:"Brick Break",src:"TM31 — Silph Co. 7F",oneTime:true},{move:"Earthquake",src:"TM26 — Viridian Gym reward",oneTime:true}],
  "Cloyster":   [{move:"Blizzard",src:"TM14 — Celadon Dept. Store (buyable)"}],
  "Omastar":    [{move:"Ice Beam",src:"TM13 — Game Corner, Celadon City"}],
  "Rhydon":     [{move:"Earthquake",src:"TM26 — Viridian Gym reward",oneTime:true},{move:"Rock Slide",src:"TM80 — Celadon Dept. Store (buyable)"}],
  ...
  "Vileplume":  [{move:"Sludge Bomb",src:"TM36 — Rocket Hideout B4F",oneTime:true},{move:"SolarBeam",src:"TM22 — Safari Zone Area 3",oneTime:true}],
  "Victreebel": [{move:"Sludge Bomb",src:"TM36 — Rocket Hideout B4F",oneTime:true},{move:"SolarBeam",src:"TM22 — Safari Zone Area 3",oneTime:true}],
  "Tauros":     [{move:"Earthquake",src:"TM26 — Viridian Gym reward",oneTime:true}],
  "Dewgong":    [{move:"Ice Beam",src:"TM13 — Game Corner, Celadon City"}],
  "Tentacruel": [{move:"Sludge Bomb",src:"TM36 — Rocket Hideout B4F",oneTime:true},{move:"Ice Beam",src:"TM13 — Game Corner, Celadon City"}],
  "Hitmonchan": [{move:"Ice Punch",src:"Level 46 (level-up)"},{move:"Brick Break",src:"TM31 — Silph Co. 7F",oneTime:true}],
  "Hitmonlee":  [{move:"Hi Jump Kick",src:"Level 41 (level-up)"},{move:"Earthquake",src:"TM26 — Viridian Gym reward",oneTime:true}],
  "Dragonite":  [{move:"Thunderbolt",src:"TM24 — Game Corner, Celadon City"},{move:"Ice Beam",src:"TM13 — Game Corner, Celadon City"},{move:"Dragon Claw",src:"TM02 — Cape Brink, Two Island"}],
};
