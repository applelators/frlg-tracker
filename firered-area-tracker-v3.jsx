...
const DT_HM_COMPAT = {
  ...
  "Strength":   new Set(["Bulbasaur","Ivysaur","Venusaur","Charmander","Charmeleon","Charizard","Squirtle","Wartortle","Blastoise","Sandshrew","Sandslash","Nidorina","Nidoqueen","Nidorino","Nidoking","Mankey","Primeape","Pikachu","Raichu","Poliwag","Poliwhirl","Poliwrath","Machop","Machoke","Geodude","Graveler","Golem","Slowpoke","Slowbro","Drowzee","Krabby","Kingler","Marowak","Hitmonlee","Hitmonchan","Rhyhorn","Rhydon","Chansey","Kangaskhan","Tauros","Gyarados","Lapras","Snorlax","Dratini","Dragonair","Dragonite","Arcanine","Aerodactyl","Electabuzz","Exeggcute","Exeggutor","Psyduck","Golduck","Onix","Lickitung"]),
...
const DT_CANDIDATES = [
  ...
  {name:"Marowak",   types:["Ground"],               hms:["Strength"]},
  ...
  {name:"Arbok",     types:["Poison"],               hms:["Cut"],                       frOnly:true},
  ...
  {name:"Persian",   types:["Normal"],               hms:["Cut"],                       lgOnly:true},
...
const DT_TM_TIPS = {
  ...
  "Vaporeon":   [{move:"Ice Beam",src:"TM13 — Game Corner, Celadon City"},{move:"Shadow Ball",src:"TM30 — Game Corner, 4,500 coins"}],
  "Jolteon":    [{move:"Thunderbolt",src:"TM24 — Game Corner, Celadon City"},{move:"Shadow Ball",src:"TM30 — Game Corner, 4,500 coins"}],
