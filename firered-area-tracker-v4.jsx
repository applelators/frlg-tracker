...
const DT_LEVEL_CAP = {
  ...
  "Venusaur":   { cap:32, reason:"Ivysaur → Venusaur at Lv 32 (Razor Leaf already at Lv 22 on Ivysaur); TM22 SolarBeam + TM36 Sludge Bomb complete the set",
    higher:[{cap:41, reason:"Growth (lv41, +1 Sp. Atk — Growth only raises Sp. Atk in Gen III, not Attack; pair with TM22 SolarBeam for a powered-up special sweep)"}] },
  ...
  "Hitmonchan": { cap:32, reason:"Learn Sky Uppercut at Lv 32; bench after — Sky Uppercut (Fighting, Physical) uses Atk 105. Note: Ice/Fire/Thunder Punch learned at Lv 26 are Ice/Fire/Electric types = Special in Gen III, using Hitmonchan's SpAtk 35 — they do almost no damage; rely on Brick Break + physical TMs instead",
    higher:[{cap:38, reason:"Mega Punch (lv38, 80BP Normal — Physical, uses Atk 105)"},{cap:50, reason:"Counter (lv50, reflects double physical damage received — devastating surprise move)"}] },
  // ── Fossils ──────────────────────────────────────────────────────────────────
  ...
  "Tentacruel": { cap:38, reason:"Learn Barrier at Lv 38 (+2 Defense, defensive utility) — bench here; TM36 Sludge Bomb + Surf cover offense",
    higher:[{cap:47, reason:"Screech (lv47, -2 Def — lowers opponents' Defense; useful before Sludge Bomb (Poison = Physical in Gen III) but does NOT help Surf — Surf is Special and bypasses Def)"},{cap:55, reason:"Hydro Pump (lv55, 120BP Water nuke — notable power upgrade over Surf's 95BP)"}] },
  ...
  "Kingler":    { cap:38, reason:"Learn Guillotine at Lv 38 (one-hit KO) — bench here; TM13 Ice Beam + Surf cover the rest; Kingler has very high Attack",
    higher:[{cap:57, reason:"Crabhammer (lv57, 90BP Water STAB — Water is Special in Gen III; uses Kingler's SpAtk 50, making it comparable to Surf at 95BP; Kingler's strength is its Atk 130 on physical moves like Guillotine)"}] },
...
const DT_TM_TIPS = {
  ...
  "Hitmonchan": [{move:"Brick Break",src:"TM31 — S.S. Anne or Celadon Dept. Store (₽3,000)"}],
  ...
  "Haunter":    [{move:"Psychic",src:"TM29 — Saffron City",oneTime:true},{move:"Shadow Ball",src:"TM30 — Game Corner, 4,500 coins (Ghost = Physical in Gen III — uses Atk 50; Psychic is the stronger damage move on Haunter/Gengar)"}],
